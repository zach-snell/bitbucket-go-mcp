...
description: Managing tasks and todos with bbkt.
---

import { Aside, Steps } from '@astrojs/starlight/components';

bbkt provides tools to manage Markdown checkbox tasks across your vault.
...
bbkt recognizes and preserves this syntax.
