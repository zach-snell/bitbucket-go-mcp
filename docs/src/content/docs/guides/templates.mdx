...
description: Using variables in templates with bbkt.
---
...
<Aside type="note">
bbkt does simple find-replace. For conditional logic, leave sections with unfilled variables and edit manually, or ask the AI to clean up after applying.
</Aside>
