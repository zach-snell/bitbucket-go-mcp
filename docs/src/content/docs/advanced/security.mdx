---
title: Security
description: Security considerations for bbkt.
---

import { Aside } from '@astrojs/starlight/components';

This page covers security considerations when using bbkt.

## Access Model

### File System Access

bbkt has **read and write access** to your vault directory and all subdirectories. It cannot access files outside the vault path you specify.
...
bbkt works directly with files. It does not:
- Connect to Obsidian
...
<Aside type="caution">
Your AI assistant (Claude, etc.) can use bbkt tools to read and modify your vault. Consider what sensitive information might be in your notes.
</Aside>

### What the AI Can Access

When you use bbkt with an AI assistant, the AI can:
...
bbkt runs as a separate process:
